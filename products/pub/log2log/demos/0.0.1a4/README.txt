...
###############################################################################
# The Log2Log Chat Log Converter project in PHP has been discontinued. This   #
# is the final release for PHP as far as Deltik knows on 23 July 2011. The    #
# project is continuing as desktop software. The v0.0.1 series of Log2Log may #
# be referred to as "Log2Log PHP". The latest information on developments is  #
# available on Deltik: <http://www.deltik.org/>                               #
###############################################################################

╔═══════════════════════════════════════════╤═╤═╤═╗
║Information                                │-│■│X║
╟───────────────────────────────────────────┴─┴─┴─╢
║Version: 0.0.1 Alpha 4 (v0.0.1a4)                ║
...
This is the structure of Log2Log:
  ...
  - ./LICENSE.txt : Know your rights when using Log2Log.
