...
$lang['2,1'] = '<input name="output" type="radio" id="output" checked="CHECKED" value="table" /><label for="table">Table </label><br /><input name="output" type="radio" id="output" value="image" /><label for="image">Image</label>';
