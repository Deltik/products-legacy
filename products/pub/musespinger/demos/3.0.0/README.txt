...
2.0.1a3
  - Cleaned up source code to meet the Deltik Programming Syntax Standard
...
2.0.1a
  - Added Background Communications

2.0.0a (2009/10/31)
  - Initial Release

1.0.0pre
  - Renamed to MuSeSPinger
  - Undocumented Version

0.5.0 (2008/20/09)
  - Released by JRD as imw_status_viewer 0.5
  - Called IMWNSC (IsMyWebsite Node Status Checker) 0.5.0
